        ...
        <div class="row m-0 p-0">
          <div class="col-lg-12 m-0 p-2 text-center text-md-left text-lg-left">
            ...
            <form method="POST" action="addmenu.php" enctype="multipart/form-data">
                        ...
                        <br>
                             <div class="form-label-group">
                            <div class="name">Kategori Menu</div>
                            <div class="value">
                                <select name="kategorimenu" id="kategorimenu">
                        ...
                        <br>
                        <div class="form-label-group">
                            <div class="name">Deskripsi Menu</div>
                            <div class="value">
                        ...
                        <br>
                        <div class="form-label-group">
                            <div class="name">Foto Menu</div>
                            <div class="value">
                                <div class="input-group js-input-file">    
                                    <input type="file" name="fotomenu" id="#">
                                </div>
