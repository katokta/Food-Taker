...
<div id="cart-page" class="container">
    <h4 class="text-center mt-md-4 mb-md-4"> Your Order </h4>
    <?php
      if(isset($_SESSION["cart_item"])){
      $total_quantity = 0;
      $total_price = 0;
  ...
  <div class="cart-item">
    <div class="menu-img"> 
        <img src="../<?php echo $item["image"]; ?>" class="cart-img-menu">
    </div>
    ...
    <div class="add-delete-item"> 
        ...
        <a href="category.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">
            <img src="../image/deleteicon.png" alt="Remove Item" style="height:30px">
        </a>
     </div>
    </div>
    ...
    ?>
    <div class="total-price mb-lg-5 mt-lg-5">
        <a class="btn btn-outline-danger float-right" data-toggle="modal" data-target="#EmptyCartAreYouSure" href="#">Empty Cart</a>
        <p class="float-left">Total Harga : <?php echo "Rp ".number_format($total_price, 2); ?></p>
        <a class="btn btn-primary float-right mr-md-4" role="button" href="payment.php">Buy</a>
    </div>
    <?php
    } else {
    ?>
